...
class ModelAdapter(ABC):
    ...
    def revise(
        ...
        *,
        ...
        """Apply one bounded revision cycle.

        Provider integrations may override this method. The default implementation performs
        deterministic wording calibration so the shadow node remains network-free.
        """
