...
**Version:** v1.0-rc2.1 Candidate  
**Status:** Candidate, awaiting formal Synthocratic Forge review and ratification  
**Operational invariant:** `REFUSE_SELF != CONTROL_OTHER`
...
- **2026-08-29, this candidate:** hardened synthesis establishing `REFUSE_SELF != CONTROL_OTHER`.
