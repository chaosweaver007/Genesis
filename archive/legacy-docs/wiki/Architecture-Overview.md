# HISTORICAL DOCUMENT — Legacy Architecture Overview

**Status:** Archived for provenance. This page describes an earlier Genesis collective-consciousness architecture and is not the current production topology. For current architecture, see `README.md` and `docs/architecture/REPOSITORY-TRUTH-MAP.md`.
